...
const AddSubjectForm = ({ open, setOpen }) => {
  ...
  const { create_module_loading } = useSelector((state) => state?.modules);
  ...
  const handleFinish = async (values) => {
    ...
    try {
      ...
      dispatch(handleCreateModule({ body: data_send }))
        .unwrap()
        .then((res) => {
          console.log(res);
          ...
          <div className="mx-auto">
            ...
            <div className="mb-8">
              ...
              <p className="text-gray-600">
                Create and configure a new teaching module
              </p>
            </div>
                ...
                <div className="border-t border-gray-200 pt-6">
                  <div className="flex justify-end gap-4">
                    ...
                    <Button
                      type="primary"
                      htmlType="submit"
                      loading={create_module_loading}
                      className="px-8 py-3 bg-[#0F7490] text-white rounded-lg hover:!bg-[#0d5f75]"
                      icon={
                        !create_module_loading ? <PlusOutlined /> : undefined
                      }
                    >
                      {create_module_loading ? "Adding..." : "Add Module"}
                    </Button>
                  </div>
                </div>
              </Form>
