...
console.log("topic-00-00-00", topic);
  ...
  return (
    <div
      className={`relative overflow-hidden rounded-3xl shadow-xl transition-all duration-300 hover:shadow-2xl hover:-translate-y-2 group cursor-pointer ${topic?.status === "active" ? "ring-2 ring-green-200" : ""
        }`}
    ...
    >
      ...
      />
      {/* Add Here Badge free */}
      {topic?.free ? <span className="absolute top-0 right-0 bg-green-500 text-white px-2 py-1 rounded-full text-xs">Free</span> : <span className="absolute top-0 right-0 bg-red-500 text-white px-2 py-1 rounded-full text-xs">Paid</span>}
      <div
          ...
          <div className="flex items-center space-x-3">
            ...
            <div className="flex flex-col">
              ...
              <div className="flex items-center mt-1">
                <span
                  className={`inline-flex items-center px-2 py-1 rounded-full text-xs font-medium ${topic?.status === "active"
                      ? "bg-green-100 text-green-800"
                      : "bg-gray-100 text-gray-600"
                    }`}
                >
                  <span
                    className={`w-2 h-2 rounded-full mr-1.5 ${topic?.status === "active"
                        ? "bg-green-500"
                        : "bg-gray-400"
                      }`}
                  />
