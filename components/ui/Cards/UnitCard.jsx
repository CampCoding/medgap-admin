          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="group/stat">
              ...
              >
                <div className="mb-2">
                  <span
                    className="text-3xl font-bold bg-gradient-to-r from-current to-opacity-80 bg-clip-text"
                    style={{ color: "#0F7490" }}
                  >
                    {unit.topics.length}
                  </span>
              ...
              >
                <div className="mb-2">
                  <span
                    ...
                    style={{ color: "#22C55E" }}
                  >
                    {unit.topics.reduce((sum, topic) => sum + (topic.digital_library || 0), 0)}
                  </span>
                </div>
                <div className="flex items-center justify-center space-x-1">
                  <BookOpen
            ...
            {/* Flashcards Card */}
            {unit.topics.some(topic => topic.flashcards > 0) && (
              <div className="group/stat">
                <div
                  className="text-center p-4 rounded-2xl transition-all duration-300 hover:scale-105 border border-opacity-10"
                  style={{
                ...
                >
                  <div className="mb-2">
                    <span
                      ...
                      style={{ color: "#F59E0B" }}
                    >
                      {unit.topics.reduce((sum, topic) => sum + (topic.flashcards || 0), 0)}
                    </span>
                  </div>
                  <div className="flex items-center justify-center space-x-1">
                    <FileText
