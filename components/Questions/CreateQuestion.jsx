...
// Utility function to validate and extract video ID from URL
...
const hasValidVideo = (option) => {
  // Valid if has either a valid URL or a video file
  return (
    (option.videoUrl && isValidVideoUrl(option.videoUrl)) ||
    (option.videoFile && option.videoFile.type.startsWith("video/"))
  );
};
...
const CreateQuestion = () => {
  ...
  const removeVideoFile = (index) => {
    const newOptions = [...options];
    newOptions[index].videoFile = null;
    setOptions(newOptions);
  };
  ...
  const isFormValid =
    questionType === "mcq" || questionType === "trueFalse"
      ? question.trim() &&
        ...
        options.every(
          (opt) => !opt.videoUrl || isValidVideoUrl(opt.videoUrl)
        ) &&
        difficulty
      ...
      <div className="max-w-7xl mx-auto">
                            ...
                            <div className="p-4 space-y-4">
                              ...
                              <div>
                                ...
                                <Input
                                  ...
                                  error={
                                    option.videoUrl &&
                                    !isValidVideoUrl(option.videoUrl)
                        ...
                        {options.some(opt => opt.videoFile || opt.videoUrl) ? (
                                ...
                                <div key={index} className="border border-gray-200 rounded-lg p-4">
                                  ...
                                  {option.videoFile && (
                                    <div className="mt-3">
                                      ...
                                      >
                                        <source 
                                          src={URL.createObjectURL(option.videoFile)} 
                                          type={option.videoFile.type} 
                                        />
                          ...
                          <div className="text-center py-8 border-2 border-dashed border-gray-200 rounded-lg">
                            ...
                            <p className="text-sm text-gray-400 mt-1">
                              Upload videos in the Editor tab under answer options
                            </p>
                          </div>
                        )}
                      </div>
                      ...
                      <div className="bg-gray-50 p-4 rounded-lg">
                        ...
                        <div className="grid grid-cols-2 gap-4">
                          <div className="text-center">
                            <div className="text-2xl font-bold text-[#0F7490]">
                      ...
                      <span className="font-medium text-[#C9AE6C]">
                        {
                            options.filter(
                              (opt) =>
                            (opt.videoUrl || "").trim() || opt.videoFile
                          ).length
                        }
                      </span>
                    </div>
        ...
        <div className="mt-8 flex items-center justify-between bg-white rounded-xl p-6 shadow-sm border border-gray-100">
          ...
          <Button
            ...
            //     videoFileName: opt.videoFile?.name,
            //     videoFileSize: opt.videoFile?.size
            //   })), 
            //   difficulty, 
            //   tags, 
            //   hint, 
            //   keywords, 
            //   helpText,
            //   videoFiles: options.filter(opt => opt.videoFile).map(opt => opt.videoFile)
            // })}
          >
                            ...
                            <div className="mt-3">
                              ...
                              {option.videoFile ? (
                                ...
                                (() => {
                                  ...
                                  const isYouTube =
                                    option.videoUrl.includes("youtube.com") ||
                                    option.videoUrl.includes("youtu.be");
                                    ...
                                    return (
                                      <div className="aspect-video max-w-md">
                                        <iframe
                                          ...
                                          allowFullScreen
                                          title={`Video explanation for option ${
                                            index + 1
                                          }`}
                                        />
                                      </div>
